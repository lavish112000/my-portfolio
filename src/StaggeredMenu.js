...
.sm-scope .staggered-menu-header { position: absolute; top: 0; right: 0; width: 100%; display: flex; align-items: center; justify-content: flex-end; padding: 3em; background: transparent; pointer-events: none; z-index: 20; }
