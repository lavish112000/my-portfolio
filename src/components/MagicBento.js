/**
 * MagicBento (Deprecated)
 * --------------------------------------------------------------------------
 * This component was an earlier experimental interactive bento grid (particles,
 * spotlight glow, tilt). Its functionality has since been replaced by inline
 * GSAP-driven panel interactions inside ProjectDetailsPage.
 * Retained temporarily for reference. Safe to delete if no longer needed.
 */
